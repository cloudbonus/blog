...
public enum ExceptionEnum {
    ...
    UNAUTHORIZED_ORDER_CREATION_ATTEMPT(HttpStatus.FORBIDDEN, "The provided request details do not match the POST/USER details."),
    STATE_TRANSITION_EXCEPTION(HttpStatus.BAD_REQUEST, "Unable to change order status"),
    //  Tag
